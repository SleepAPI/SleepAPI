import { Ingredient, IngredientIndexToAmount, IngredientSet } from '../../domain/ingredient/ingredient';
...
export function ingredientSetToFlat(ingredientSet: IngredientSet[]): Float32Array {
...
export function flatToIngredientSet(ingredients: Float32Array): IngredientSet[] {
...
export function isFlat(ingredients: IngredientSet[] | IngredientIndexToAmount): ingredients is IngredientIndexToAmount {
  return ingredients instanceof Float32Array;
}

export function shortPrettifyIngredientDrop(ingredients: IngredientSet[]): string;
export function shortPrettifyIngredientDrop(ingredients: IngredientIndexToAmount): string;
export function shortPrettifyIngredientDrop(ingredients: IngredientSet[] | IngredientIndexToAmount): string {
...
export function prettifyIngredientDrop(ingredients: IngredientIndexToAmount, separator?: string): string;
export function prettifyIngredientDrop(
  ingredients: IngredientSet[] | IngredientIndexToAmount,
  separator = ', '
): string {
  const ingredientSet = isFlat(ingredients) ? flatToIngredientSet(ingredients) : ingredients;
