...
import { mocko } from '@src/vitest/mocks/index.js';
...
describe('solve.controller', () => {
  ...
  describe('enrichMemberSettings', () => {
    ...
    it('should enrich member settings with valid inputs', () => {
      ...
      const natureMock = mocko(common, 'getNature', () => nature.BASHFUL);
  ...
  describe('resultToResponse', () => {
    ...
    it('should map result to response correctly', () => {
      ...
      const flatToIngredientSetMock = mocko(common, 'flatToIngredientSet', () => mockedIngredientSet);
      const getPokemonMock = mocko(common, 'getPokemon', () => mockedPokemon);
