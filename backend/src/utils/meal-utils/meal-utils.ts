...
import { RECIPES, Recipe, Time, TimePeriod } from 'sleepapi-common';
import { MealError } from '../../domain/error/meal/meal-error.js';

// TODO: rename utils to recipe-utils, rename all functions/variables to recipe
