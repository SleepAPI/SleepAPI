...
// // TODO: to be removed?
// export function createProduceMap(defaultProduce: SetCoverPokemonSetup[]) {
//   const map: Map<string, SetCoverPokemonSetup> = new Map();
//   for (const pokemonWithProduce of defaultProduce) {
//     const hashedPokemon = hashPokemonCombination(pokemonWithProduce.pokemonSet);
