...
describe('CookingState', () => {
  ...
  it('shall cook mixed meal if team cant cook better', () => {
    ...
    cookingState.addIngredients(ingredientSetToFlat([{ amount: 1, ingredient: ingredient.SLOWPOKE_TAIL }]));
  ...
  it('shall crit with max bonus on sunday', () => {
    ...
    cookingState.addIngredients(ingredientSetToFlat(dessert.FLOWER_GIFT_MACARONS.ingredients));
