...
export class CookingState {
  ...
  private currentCurryInventory: Float32Array = emptyIngredientInventoryFlat();
  private currentSaladInventory: Float32Array = emptyIngredientInventoryFlat();
  private currentDessertInventory: Float32Array = emptyIngredientInventoryFlat();

  constructor(camp: boolean) {
    this.camp = camp;
  }

  public addIngredients(ingredients: Float32Array) {
  ...
  private cookRecipeType(params: {
    ...
    currentIngredients: Float32Array;
