...
import { IngredientIndexToFloatAmount, IngredientIndexToIntAmount, IngredientSet, Pokemon } from 'sleepapi-common';
...
export function getAllIngredientCombinationsForLevel(pokemon: Pokemon, level: number): IngredientSet[][] {
