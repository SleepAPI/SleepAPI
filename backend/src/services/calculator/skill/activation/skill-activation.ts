...
// TODO: need to support moonlight crit, if it's like energizing cheer and can hit umbreon and
// TODO: just has flat crit chance on every skill proc then we can probably just calc average energy per member from crit
