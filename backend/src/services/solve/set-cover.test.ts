...
import { ingredient, IngredientIndexToIntAmount, IngredientSet, ingredientSetToIntFlat } from 'sleepapi-common';
...
describe('SetCover', () => {
  ...
  describe('solveRecipe', () => {
    let mockedKeyCall: MockInstance;
    ...
    it('should solve realistic Inferno Corn Keema Curry', () => {
      ...
      mockedKeyCall = vimic(setCoverUtils, 'createMemoKey', firstMemoKey, secondMemoKey);
      mockedKeyCall.mockResolvedValueOnce(789);
