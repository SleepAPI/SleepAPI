  ...
  <v-row no-gutters class="flex-center pb-1">
    <v-col cols="auto" class="flex-center flex-nowrap mx-4">
      ...
      >
        <v-img
          ...
          height="40px"
          width="40px"
          :alt="`Nuzzle (Energizing Cheer S) level ${effectiveSkillLevel}`"
    ...
    <v-col cols="auto" class="flex-center flex-column">
      <div class="flex-center">
        ...
        <!-- TODO: Add skill helps info as well. -->
      </div>
    </v-col>
  </v-row>
</template>
...
export default defineComponent({
  ...
  computed: {
    ...
    totalSkillHelps() {
      const helpsSkillValue = this.memberWithProduction.production.skillValue['skill helps'] ?? {
        amountToSelf: 0,
        amountToTeam: 0
      }
