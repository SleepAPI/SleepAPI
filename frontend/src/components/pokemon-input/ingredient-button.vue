...
<script lang="ts">
import { MOCK_POKEMON, type IngredientSet, type Pokemon, type PokemonInstanceExt } from 'sleepapi-common'
...
export default {
  ...
  methods: {
    ...
    loadFromExisting(oldPokemon: Pokemon) {
      ...
      return oldPokemon.name === MOCK_POKEMON.name && existingIngredients
    }
  }
}
</script>
