...
<script lang="ts">
import { MOCK_POKEMON, RandomUtils, type Pokemon, type PokemonInstanceExt } from 'sleepapi-common'
  ...
  watch: {
    pokemon: {
      ...
      handler(newPokemon: Pokemon, oldPokemon: Pokemon) {
        ...
        const loadFromExisting = oldPokemon.name === MOCK_POKEMON.name && this.pokemonInstance.gender !== undefined
